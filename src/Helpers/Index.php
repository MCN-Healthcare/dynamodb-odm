...
class Index
{
    ...
    protected $hashKey;
    protected $hashKeyType         = Item::ATTRIBUTE_TYPE_STRING;
    protected $rangeKey            = null;
    protected $rangeKeyType        = Item::ATTRIBUTE_TYPE_STRING;
    protected $projectionType      = self::PROJECTION_TYPE_ALL;
    protected $projectedAttributes = [];

    public function __construct($hashKey,
                                $hashKeyType = Item::ATTRIBUTE_TYPE_STRING,
                                $rangeKey = null,
                                $rangeKeyType = Item::ATTRIBUTE_TYPE_STRING,
